...
class LoginPage:
    def __init__(self):
        ...
        login_icon_data = Image.open("login-icon.png")
        ...
        login_icon = CTkImage(dark_image=login_icon_data, light_image=login_icon_data, size=(20, 20))

        ## Create UI elements
        CTkLabel(master=self.login_page, text="", image=side_img).pack(expand=True, side="left")

        frame = CTkFrame(master=self.login_page, width=300, height=480, fg_color="#ffffff")
        ...
        CTkEntry(master=frame, width=225, fg_color="#EEEEEE", border_color="#071952", border_width=1,
        ...
        CTkButton(master=frame, text="Login", image=login_icon, fg_color="#419197", hover_color="#12486B",
                  ...
                  command=lambda: print("Login pressed")).pack(anchor="w", pady=(40, 0), padx=(25, 0))
