...
class MainPage:
    def __init__(self):
        ...
        self.sidebar_frame = CTkFrame(master=self.main_page, fg_color="#040D12", width=200, height=650, corner_radius=0)
        self.sidebar_frame.pack_propagate(0)
        self.sidebar_frame.pack(fill="y", anchor="w", side="left")
        logo_img = CTkImage(dark_image=logo_img_data, light_image=logo_img_data, size=(150.68, 170.42))
        ...
        button_container = CTkFrame(master=self.main_frame, fg_color="#040D12",width=150, height=75)
        button_container.pack(anchor="ne", fill="both", padx=10, pady=(20, 5))

        # Logout Button
        logout_img_data = Image.open("logout.png")
        logout_img = CTkImage(dark_image=logout_img_data, light_image=logout_img_data, size=(18, 18))
        ...
        # Send Reports Button
        send_report_img_data = Image.open("SendReports.png")
        send_report_img = CTkImage(dark_image=send_report_img_data, light_image=send_report_img_data, size=(18, 18))
        ...
        welcome_message.pack(anchor="center", fill="both", padx=10, pady=(3, 0))

        ## Metrics frame properties
        metrics_frame = CTkFrame(master=self.main_frame, fg_color="#040D15",width=150, height=75)
        metrics_frame.pack(anchor="nw", fill="x",  padx=10, pady=(20, 20))

        hours_metric = CTkFrame(master=metrics_frame, fg_color="#35A29F",width=250, height=75)
        hours_metric.grid_propagate(0)
        hours_metric.pack(side="left")

        hours_img_data = Image.open("Hours.png")
        hours_img = CTkImage(light_image=hours_img_data, dark_image=hours_img_data, size=(43, 43))

        CTkLabel(master=hours_metric, image=hours_img, text="").grid(row=0, column=0, rowspan=2, padx=(12,5), pady=10)
        CTkLabel(master=hours_metric, text="Hours Played", text_color="#fff", font=("Dungeon", 15)).grid(row=0, column=1, sticky="sw")
        CTkLabel(master=hours_metric, text="124 Hour", text_color="#fff",font=("Dungeon", 15), justify="left").grid(row=1, column=1, sticky="nw", pady=(0,10))

        revenues_metric = CTkFrame(master=metrics_frame, fg_color="#35A29F", width=250, height=75)
        revenues_metric.grid_propagate(0)
        revenues_metric.pack(side="left",expand=True, anchor="center")

        revenues_img_data = Image.open("Revenues.png")
        revenues_img = CTkImage(light_image=revenues_img_data, dark_image=revenues_img_data, size=(43, 43))

        CTkLabel(master=revenues_metric, image=revenues_img, text="").grid(row=0, column=0, rowspan=2, padx=(12,5), pady=10)
        CTkLabel(master=revenues_metric, text="Revenues", text_color="#fff", font=("Dungeon", 15)).grid(row=0, column=2, sticky="nw")
        CTkLabel(master=revenues_metric, text="37,000.00", text_color="#fff",font=("Dungeon", 15), justify="left").grid(row=1, column=2, sticky="s", pady=(0,10))

        expense_metric = CTkFrame(master=metrics_frame, fg_color="#35A29F", width=250, height=75)
        expense_metric.grid_propagate(0)
        expense_metric.pack(side="right")

        expense_img_data = Image.open("Expenses.png")
        expense_img = CTkImage(light_image=expense_img_data, dark_image=expense_img_data, size=(43, 43))

        CTkLabel(master=expense_metric, image=expense_img, text="").grid(row=0, column=0, rowspan=2, padx=(12,5), pady=10)

        CTkLabel(master=expense_metric, text="Expenses", text_color="#fff", font=("Dungeon", 15)).grid(row=0, column=4, sticky="nw")
        CTkLabel(master=expense_metric, text="23,000.00", text_color="#fff",font=("Dungeon", 15), justify="left").grid(row=1, column=4, sticky="s", pady=(0,10))
        ...
        inputs_img_data = Image.open("inputs.png")
        inputs_img = CTkImage(dark_image=inputs_img_data, light_image=inputs_img_data)
        ...
        units_img_data = Image.open("units.png")
        units_img = CTkImage(dark_image=units_img_data, light_image=units_img_data)
        ...
        employees_img_data = Image.open("employees.png")
        employees_img = CTkImage(dark_image=employees_img_data, light_image=employees_img_data)
        ...
        users_img_data = Image.open("users.png")
        users_img = CTkImage(dark_image=users_img_data, light_image=users_img_data)
        CTkButton(master=self.scrollable_frame, image=users_img, text="Users Data",
                  fg_color="transparent", 
                  font=("Arial Bold", 14), hover_color="#EE9322", anchor="w",
                  command= lambda: print('button pressed')).pack(anchor="w", ipady=5, pady=(16, 0))
        
        inventory_img_data = Image.open("inventory.png")
        ...
        transactions_img_data = Image.open("transactions.png")
        ...
        timesheet_img_data = Image.open("timesheet.png")
        timesheet_img = CTkImage(dark_image=timesheet_img_data, light_image=timesheet_img_data)
        CTkButton(master=self.scrollable_frame, image=timesheet_img, text="Time Sheet",
                  fg_color="transparent", 
                  font=("Arial Bold", 14), hover_color="#EE9322", anchor="w",
                  command= lambda: print('button pressed')).pack(anchor="w", ipady=5, pady=(16, 0))

        expenses_img_data = Image.open("expenses.png")
        expenses_img = CTkImage(dark_image=expenses_img_data, light_image=expenses_img_data)
        ...
        revenues_img_data = Image.open("revenues.png")
        revenues_img = CTkImage(dark_image=revenues_img_data, light_image=revenues_img_data)
        CTkButton(master=self.scrollable_frame, image=revenues_img, text="Revenues",
                  fg_color="transparent", 
                  font=("Arial Bold", 14), hover_color="#EE9322", anchor="w",
                  command= lambda: print('button pressed')).pack(anchor="w", ipady=5, pady=(16, 0))
        
        cash_img_data = Image.open("cash.png")
        cash_img = CTkImage(dark_image=cash_img_data, light_image=cash_img_data)
        CTkButton(master=self.scrollable_frame, image=cash_img, text="Cash Data",
                fg_color="transparent", 
                font=("Arial Bold", 14), hover_color="#EE9322", anchor="w",
                command= lambda: print('button pressed')).pack(anchor="w", ipady=5, pady=(16, 0))
        
        reports_img_data = Image.open("reports.png")
        ...
        account_img_data = Image.open("account.png")
        account_img = CTkImage(dark_image=account_img_data, light_image=account_img_data)
        ...
        configuration_img_data = Image.open("configuration.png")
        configuration_img = CTkImage(dark_image=configuration_img_data, light_image=configuration_img_data, size=(50, 50))
        ...
        changepassword_img_data = Image.open("changepassword.png")
        changepassword_img = CTkImage(dark_image=changepassword_img_data, light_image=changepassword_img_data, size=(50, 50))
        ...
        configuration_img_data2 = Image.open("configuration.png")
        configuration_img2 = CTkImage(dark_image=configuration_img_data2, light_image=configuration_img_data2, size=(50, 50))
        ...
        changepassword_img_data2 = Image.open("changepassword.png")
        changepassword_img2 = CTkImage(dark_image=changepassword_img_data2, light_image=changepassword_img_data2, size=(50, 50))
        ...
        configuration_button.grid(row=0, column=1, padx=10, pady=10, sticky="e")
        changepassword_button.grid(row=0, column=2, padx=10, pady=10, sticky="w")
        configuration_button2.grid(row=0, column=1, padx=10, pady=10, sticky="e")
        changepassword_button2.grid(row=0, column=2, padx=10, pady=10, sticky="w")
